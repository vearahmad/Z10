                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        plist.append('first2000last')
                                        plist.append('first2001last')
                                        plist.append('first2002last')
                                        plist.append('first2003last')
                                        plist.append('first2004last')
                                        plist.append('first2005last')
                                        plist.append('first2006last')
                                        plist.append('first2007last')
                                        plist.append('first2008last')
                                        plist.append('first2009last')
                                elif ppp in ['3','03']:
